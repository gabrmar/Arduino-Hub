...
void setup()
{
	...
	//correct for Stepper.h's omission of first step initialization
	//by making sure stepper is in reference 12-o'clock position 
...
void loop()
{
	...
	delay(200);//some loop delay() as normal
}
